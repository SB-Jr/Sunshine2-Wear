...
import com.example.android.sunshine.app.wearable.WearSyncClass;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if(i==0){
                    /**
                     * notifying weather to wear*/
                    WearSyncClass wearSyncClass = new WearSyncClass(getContext(),high,low,weatherId);
                    Log.d("wear","sending data from sync adapter");
                }
            }
