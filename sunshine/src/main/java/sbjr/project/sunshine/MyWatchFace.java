...
public class MyWatchFace extends CanvasWatchFaceService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,DataApi.DataListener{
        ...
        for (DataEvent event : dataEventBuffer) {
            if (event.getType() == DataEvent.TYPE_CHANGED) {
                ...
                if (item.getUri().getPath().compareTo("/weather") == 0) {
                    ...
                    engine.updateData(dataMap.getString("weather"),dataMap.getString("max"),dataMap.getString("min"));
                }
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        String weather,max,min;


        public void updateData(String weather,String max,String min){
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            if (isInAmbientMode()) {
                ...
                if(weather!=null){
                    canvas.drawText("hello", mDateXOffset, mDateYOffset+50, mDatePaint);
                    canvas.drawText(max, mDateXOffset, mDateYOffset+50, mDatePaint);
                    canvas.drawText(min, mDateXOffset, mDateYOffset+50, mDatePaint);
                }
            }
